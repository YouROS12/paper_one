...
\multirow{6}{*}{Visual Grouping (19 Classes)} 
 ...
 & \textbf{YOLOv8m (Champion)} & \textbf{IPCA} & \textbf{86.54} & \textbf{0.863} & \textbf{29.7} \\
 & YOLOv8m & SVD & 86.03 & 0.854 & 26.4 \\
\midrule
\multirow{6}{*}{Treatment Grouping (11 Classes)} 
 ...
 & \textbf{YOLOv8m (Champion)} & \textbf{IPCA} & \textbf{87.52} & \textbf{0.882} & \textbf{30.8} \\
 & YOLOv8m & SVD & 86.54 & 0.874 & 28.1 \\
\bottomrule
\end{tabular}%
}
\end{table}
...
\textbf{Proposed Pipeline (YOLO+IPCA)} & \textbf{87.52\%} & \textbf{30.8 seconds} & \textbf{CPU} & \textbf{Negligible} \\ \hline
\end{tabular}
\end{table}
